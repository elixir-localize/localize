...
* Locale management — per-process locale via `get_locale/0` and `put_locale/1`, application-wide default resolved from environment variables and application config.
