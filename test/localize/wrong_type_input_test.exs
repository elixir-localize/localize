defmodule Localize.WrongTypeInputTest do
  ...
  test "options that are not a keyword list are an InvalidValueError" do
    ...
    calls = [
      ...
      {"Localize.Locale.LocaleDisplay.key_name/2",
       &Localize.Locale.LocaleDisplay.key_name(:ca, &1)},
      {"Localize.Locale.LocaleDisplay.type_name/3",
       &Localize.Locale.LocaleDisplay.type_name(:ca, :buddhist, &1)},
      ...
      {"Localize.DateTime.SemanticSkeleton.new/2",
       &Localize.DateTime.SemanticSkeleton.new("YMD", &1)},
      ...
      {"Localize.MinimalPairs.format/3", &Localize.MinimalPairs.format(1, :cardinal, &1)},
      ...
      {"Localize.Unit.grammatical_gender/2", &Localize.Unit.grammatical_gender(unit, &1)},
      ...
      {"Localize.Inflection.Concept.new/3", &Localize.Inflection.Concept.new(:de, "Haus", &1)},
      {"Localize.Inflection.PronounConcept.new/2",
       &Localize.Inflection.PronounConcept.new(:en, &1)}
    ]
  ...
  test "arguments of the wrong type are a Localize error" do
    ...
    cases = [
      ...
      {"Localize.MinimalPairs.format/3", [nil, :bogus, "x", %{}, {1, 2}],
       &Localize.MinimalPairs.format(&1, :cardinal, locale: :en)},
      ...
      {"Localize.Inflection.SpeakableString.print/1", [nil, :bogus, 42, %{}, {1, 2}, [1]],
       &Localize.Inflection.SpeakableString.print(&1)},
      ...
      {"Localize.Unit.grammatical_gender/2", @not_units,
       &Localize.Unit.grammatical_gender(&1, [])},
