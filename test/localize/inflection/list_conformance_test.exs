defmodule Localize.InflectionListConformanceTest do
  ...
  test "5.18 testListHi (hi)" do
    # Upstream asserts a comma before the conjunction — "1, 2, और 3" —
    # which was Hindi's `end` list pattern in CLDR 48. CLDR 49 changed
    # it to `{0} और {1}`, dropping the comma, so the expectations below
    # follow the shipped data rather than the upstream fixture. The
    # `2` pattern is unchanged and still has no comma.
