defmodule Localize.Inflection.PronounConformance do
  ...
  @doc """
  Returns the glob matching the upstream pronoun fixture files.

  """
  def fixtures, do: "data/inflection/test/pronoun_*.xml"

  @doc """
  Returns one `{locale, path}` pair per upstream pronoun fixture file,
  with the locale in the internal underscore form.
