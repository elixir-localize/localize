...
The skill source lives in [skills/localize](https://github.com/elixir-localize/localize/blob/v1.3.1/skills/localize/SKILL.md).
...
Apache License 2.0, together with the Unicode License v3 for the CLDR and UCD data embedded in the package. See the [LICENSE](https://github.com/elixir-localize/localize/blob/v1.3.1/LICENSE.md) file for details, including which Unicode data is used and what it becomes.
