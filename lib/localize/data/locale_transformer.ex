defmodule Localize.Data.LocaleTransformer do
  @moduledoc """
  Transforms raw CLDR locale data maps into pre-built Elixir structs.

  Converts plain maps for number symbols, number formats, and currencies
  into their corresponding `Localize` struct types so that the saved ETF
  files contain ready-to-use structs without per-access transformation.
